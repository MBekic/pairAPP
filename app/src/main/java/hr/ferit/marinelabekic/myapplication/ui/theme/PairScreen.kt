...
@Composable
fun PairScreen(viewModel: PersonViewModel, navController: NavController) {
    ...
    )
    {
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.pair),
            ...
            PrintPairScreen(viewModel = viewModel)
...
@Composable
fun PrintPairScreen(viewModel: PersonViewModel) {
    ...
    Box(
        ...
        LazyColumn(
            ...
            items(people) { person ->
                if (!displayedIds.contains(person.id)) {
                    displayedIds.add(person.id)
                    displayedIds.add(person.pairId)
                    ...
                    Column {
                        Row(
                            ...
                            Box(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.botharr),
